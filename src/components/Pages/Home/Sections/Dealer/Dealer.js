            ...
            <div className='row dealer-sec'>
                ...
                <div className='col-sm-12 col-md-6 my-5'>
                    ...
                    <form className='w-75 mx-auto' onSubmit={handleSubmit}>
                        <input placeholder='Your Name' className='form-control' type="text" />
                        <input placeholder=' Your Email' className='form-control' type="email" name="" id="" />
                        <input placeholder=' Your Phone' className='form-control' type="text" name="" id="" />
                        <input placeholder=' Your Address' className='form-control' type="text" />
